...
> | 🎚️ **[Steering study — layers × strength × combinations](https://projects.laion.ai/laion-moss-local-1.5-voice-acting-4.55b/steering-study.html)** | 12,136 generated clips. The delivery-style axes steer far better than emotion: `S_DRAM` +1.78 with the word error rate *improving*, against +0.10 for emotion at the same budget. Which layers, which strengths, and what each move costs. |
